                          Binary installers for
                    CUnit libraries with MS Visual C/C++

These installers contain CUnit static libraries for Microsoft Visual Studio
2015 and Microsoft Visual C/C++ 14.
...
From C source files of your application unitary tests, use CUnit the same way
as on any platform. Namely, from any source file:

  #include <CUnit/CUnit.h>

Compiling and linking is done transparently.
